...
import { buildFolderPathMap } from "../../packs/registry/CompendiumFolderIndex.js";
import { ProvisionsCustomPack, PROVISIONS_CUSTOM_PACK_ID } from "../../meal/provisions/ProvisionsCustomPack.js";
import { isHomebrewProvisionOnly } from "../settings/TravelSettings.js";
...
export async function resolveProvisionPoolEntry(entry) {
    ...
    if (itemRef) {
        const { ItemOutcomeHandler } = await import("../../crafting/outcomes/ItemOutcomeHandler.js");
