...
import { ConditionAdvisory } from "../../rest/recovery/ConditionAdvisory.js";
import { ResourceSink } from "../../rest/recovery/ResourceSink.js";
...
export class TravelMishapHandler {
     ...
     * @param {import("../../rest/flow/RestFlowEngine.js").RestFlowEngine|null} engine
     * @param {Object} [options]
     * @param {Object} [options.mutateTarget] - If set, store effectsApplied / appliedSummaries on this object.
     * @returns {Promise<string[]>} End-user-readable summary lines for UI badges.
     */
