...
import { buildEventPlayerRollContext, buildRollTargetLabel, buildEventGmRollContext, centerRollRequestRoster, buildTreePlayerRollContext, buildCampActivityRollContext, buildTravelActivityRollContext, buildCopySpellRollContext } from "../../services/ui/rollRequest/RollRequestView.js";
...
import { SoundDelegate } from "../delegates/rest/SoundDelegate.js";
import { TravelResolutionDelegate } from "../delegates/travel/TravelResolutionDelegate.js";
import { RestSetupDebugJumps } from "../delegates/rest/RestSetupDebugJumps.js";
...
import { DetectMagicDelegate, collectPartyIdentifyEmbedData, computeCanShowDetectMagicScanButton, computeCanTriggerDetectMagicScan, spawnDetectMagicCastRipple, purgeDetectMagicRestArtifacts } from "../delegates/crafting/DetectMagicDelegate.js";
...
} from "../../services/camp/gear/campCeremonySync.js";
import { isSimpleStationsMode, requiresMapCampFire, isCampfireMinigameEnabled } from "../../services/rest/flow/RestProfileSettings.js";
import { isScoutingEnabled } from "../../services/travel/settings/ScoutingSettings.js";
import { shouldRunTravelPhase, getTravelGatherAvailability } from "../../services/travel/settings/TravelSettings.js";
...
/** Dev console.debug when a method runs without _engine on a player client. */
...
/** True when testharness trailer filming mode is active (suppresses window auto-recenter). */
...
export class RestSetupApp extends HandlebarsApplicationMixin(ApplicationV2) {
     ...
     * @returns {import("../../services/rest/flow/RestFlowEngine.js").RestFlowEngine|null}
     */
    getRestFlowEngine() {
    ...
    static async #onGrantDiscoveryItem(event, target) {
        ...
        try {
            const { ItemOutcomeHandler } = await import("../../services/crafting/outcomes/ItemOutcomeHandler.js");
            const colon = grantKey.indexOf(":");
     ...
     * @param {import("../camp/StationActivityDialog.js").StationActivityDialog|null} dialog
     */
