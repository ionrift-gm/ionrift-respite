...
60+ events across 6 terrains (forest, desert, swamp, urban, dungeon, tavern), each with multiple outcome tiers. Collected over years of running a primitive version of this module at the table. Events have weighted probability and narrative branching. The GM can Force Pass or Force Fail any outcome.
